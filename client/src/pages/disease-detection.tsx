...
export default function DiseaseDetection() {
  ...
  const detectMutation = useMutation({
    mutationFn: async (formData: FormData) => {
      const res = await apiRequest("POST", "/api/disease-detect", formData);
  ...
  return (
    <div className="container mx-auto p-6 space-y-6 max-w-5xl">
      ...
      >
        <h1 className="text-3xl font-display font-bold text-foreground flex items-center gap-2" data-testid="text-disease-title">
          <Camera className="h-8 w-8 text-primary" />
          {t("diseaseDetection")}
        </h1>
        <p className="text-muted-foreground mt-1">Upload crop images for AI-powered disease diagnosis</p>
      </motion.div>
        ...
        >
          <Card className="h-full" data-testid="card-upload">
            ...
            <CardContent className="space-y-4">
              ...
              >
                {previewUrl ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <p className="text-foreground font-medium">{t("dragDropImage")}</p>
              ...
              >
                {detectMutation.isPending && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
                {t("detectDisease")}
              </Button>
            </CardContent>
          </Card>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3 p-4 bg-muted rounded-lg">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-lg" data-testid="text-disease-name">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground pl-6" data-testid="text-treatment">
